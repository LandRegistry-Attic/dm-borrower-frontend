class Deed:
    def __init__(self, deed_reference, borrowers, title_number, lender, charge_clause,
                 additional_provisions, identity_checked):
        ...
        self.identity_checked = identity_checked
